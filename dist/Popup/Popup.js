...
var Backend = function () {
  ...
  _createClass(Backend, [{
      ...
      return new Promise(function (resolve, reject) {
        chrome.storage.sync.get('user', function (storage) {
          if (typeof storage.user === 'undefined') {
            _this.fetch('https://api.github.com/user').then(function (json) {
              var user = {
    ...
    key: 'getLocationItem',
    value: function getLocationItem() {
      return new Promise(function (resolve) {
        chrome.tabs.query({ active: true, lastFocusedWindow: true }, function (tabs) {
          var url = tabs[0].url;
          var parts = url.match(/^https:\/\/github\.com\/([\w-]+\/)([\w-]+\/)(issues|pull)\/(\d+)(?:#[\w-]+)?$/);
    ...
    key: 'getTrackedItems',
    value: function getTrackedItems() {
      var _this2 = this;

      return new Promise(function (resolve) {
        chrome.storage.sync.get('trackedItems', function (storage) {
          var items = storage.trackedItems;
          ...
          resolve(_this2.objectToArray(items));
        });
      });
    }
    ...
    key: 'addTrackedItem',
    value: function addTrackedItem(vendor, project, type, ticket) {
      var _this3 = this;

      return new Promise(function (resolve) {
        var itemType = type === 'pull' ? 'pulls' : type;

        _this3.fetch('https://api.github.com/repos/' + vendor + '/' + project + '/' + itemType + '/' + ticket).then(function (json) {
          chrome.storage.sync.get('trackedItems', function (storage) {
            ...
            chrome.storage.sync.set({ trackedItems: trackedItems }, function () {
              resolve(_this3.objectToArray(trackedItems));
            });
          });
        });
      });
    ...
    key: 'removeTrackedItem',
    value: function removeTrackedItem(id) {
      var _this4 = this;
      ...
      return new Promise(function (resolve) {
        chrome.storage.sync.get('trackedItems', function (storage) {
          ...
          chrome.storage.sync.set({ trackedItems: trackedItems }, function () {
            resolve(_this4.objectToArray(trackedItems));
          });
        });
      });
    }
    ...
    key: 'updateTrackedItem',
    value: function updateTrackedItem(json) {
      var _this5 = this;
      ...
      return new Promise(function (resolve, reject) {
        chrome.storage.sync.get('trackedItems', function (storage) {
          ...
          if (typeof trackedItems === 'undefined' || typeof trackedItems[json.id] === 'undefined') {
            reject();
          }
          ...
          chrome.storage.sync.set({ trackedItems: trackedItems }, function () {
            resolve(_this5.objectToArray(trackedItems));
          });
        });
      });
    }
    ...
    key: 'syncTrackedItems',
    value: function syncTrackedItems() {
      var _this6 = this;

      return new Promise(function (resolve, reject) {
        _this6.getTrackedItems().then(function (items) {
          if (items.length === 0) {
            resolve(items);
            return;
          }
          ...
          Promise.all(items.map(function (item) {
            ...
            Promise.all(updates.map(function (json) {
              return _this6.updateTrackedItem(json);
...
function LoadingIndicator() {
  var props = arguments.length <= 0 || arguments[0] === undefined ? { showText: false } : arguments[0];
...
var _Backend = require('../Backend/Backend');

var _Backend2 = _interopRequireDefault(_Backend);

var _LoadingIndicator = require('../LoadingIndicator/LoadingIndicator');

var _LoadingIndicator2 = _interopRequireDefault(_LoadingIndicator);

var _TypeIcon = require('../TypeIcon/TypeIcon');

var _TypeIcon2 = _interopRequireDefault(_TypeIcon);
...
var Popup = function (_React$Component) {
  ...
  function Popup(props) {
    ...
    props.chrome.storage.sync.get('oauthToken', function (result) {
      _this.setState({ hasToken: typeof result.oauthToken !== 'undefined' });
    });

    props.backend.getUser().then(function (user) {
      _this.setState({ user: user });
    });

    props.backend.getLocationItem().then(function (locationItem) {
      _this.setState({ locationItem: locationItem });
    });

    props.backend.syncTrackedItems().then(function (trackedItems) {
      _this.setState({ syncing: false, trackedItems: trackedItems });
    });

    _this.handleOptionsLinkClick = _this.handleOptionsLinkClick.bind(_this);
    _this.handleAddButtonClick = _this.handleAddButtonClick.bind(_this);
    _this.handleRemoveButtonClick = _this.handleRemoveButtonClick.bind(_this);
    return _this;
  }

  _createClass(Popup, [{
    key: 'handleOptionsLinkClick',
    value: function handleOptionsLinkClick() {
    ...
    value: function handleAddButtonClick() {
      ...
      this.props.backend.addTrackedItem(this.state.locationItem.vendor, this.state.locationItem.project, this.state.locationItem.type, this.state.locationItem.ticket).then(function (trackedItems) {
        _this2.setState({
          addingItem: false,
    ...
    value: function handleRemoveButtonClick(event) {
      ...
      this.props.backend.removeTrackedItem(event.target.dataset.id).then(function (trackedItems) {
        _this3.setState({ trackedItems: trackedItems });
      });
    }
  }, {
    key: 'renderSetupView',
    value: function renderSetupView() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: '#', onClick: this.handleOptionsLinkClick },
            'options'
          ),
          '.'
        )
    ...
    key: 'renderContentView',
    value: function renderContentView() {
      var _this4 = this;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              this.state.addingItem && _react2.default.createElement(_LoadingIndicator2.default, null),
              !this.state.addingItem && _react2.default.createElement(
                'span',
                null,
                'Add to list'
              )
            ),
            this.state.locationItem && _react2.default.createElement(
              'p',
              { className: 'add-button-description' },
        ...
        this.state.syncing && _react2.default.createElement(
          ...
          _react2.default.createElement(_LoadingIndicator2.default, { showText: true })
        ),
        !this.state.syncing && this.state.trackedItems.length > 0 && _react2.default.createElement(
          'div',
          { className: 'tracked-items-container' },
          _react2.default.createElement(
            'ul',
            ...
            this.state.trackedItems.sort(function (a, b) {
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(_TypeIcon2.default, {
                  ...
                  _react2.default.createElement(
                    'span',
                    { className: 'tracked-item-list__tracked-item__updated' },
    ...
    value: function render() {
      return this.state.hasToken ? this.renderContentView() : this.renderSetupView();
    }
  }]);
...
Popup.propTypes = {
  ...
  chrome: _react2.default.PropTypes.object.isRequired
};

// Called when the popup is opened.
document.addEventListener('DOMContentLoaded', function () {
  var props = {
    backend: new _Backend2.default(),
    chrome: chrome
  };

  _reactDom2.default.render(_react2.default.createElement(Popup, props), document.getElementById('popup-view'));
});

},{"../Backend/Backend":165,"../LoadingIndicator/LoadingIndicator":166,"../TypeIcon/TypeIcon":168,"react":164,"react-dom":1}],168:[function(require,module,exports){
'use strict';
...
TypeIcon.propTypes = {
  mergeable: _react2.default.PropTypes.bool.isRequired,
  mergeableState: _react2.default.PropTypes.string.isRequired,
  merged: _react2.default.PropTypes.bool.isRequired,
  state: _react2.default.PropTypes.string.isRequired,
  type: _react2.default.PropTypes.string.isRequired
};

exports.default = TypeIcon;
